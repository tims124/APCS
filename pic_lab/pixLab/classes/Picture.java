...
public class Picture extends SimplePicture
{
  ...
  public void negate(){
    ...
    for (Pixel[] rowArray : pixels)
    {
      for (Pixel pixelObj : rowArray)
      {
        int nr = pixelObj.getRed() - 225;
		    int ng = pixelObj.getGreen() - 255;
		    int nb = pixelObj.getBlue() -255;

		pixelObj.setRed(nr);
		pixelObj.setGreen(ng);
		pixelObj.setBlue(nb);
      }
    }
  }
  ...
  public void fixUnderwater(){
    ...
    Pixel[][] pixels = this.getPixels2D();
      for (Pixel[] rowArray : pixels)
      {
        for (Pixel pixelObj : rowArray)
        {
          if(r - pixelObj.getRed() > 5 || pixelObj.getRed() - r > 5){
            r = pixelObj.getRed();
            pixelObj.setRed(0);
      		    pixelObj.setGreen(0);
      		      pixelObj.setBlue(0);
...
*/
  ...
  public void mirrorArms(){
    ...
    {
      // loop from 13 to just before the mi rror point
